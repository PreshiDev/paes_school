...
const teamList: TeamProps[] = [
  {
    imageUrl: image1,
    name: "Miss Ifeoma Osuya - Ag.",
    position: "Principal (Senior Secondary)",
    // socialNetworks: [
    //   {
    //     name: "Linkedin",
  ...
  {
    imageUrl: image4,
    name: "Mrs Victoria Egoride - Asst",
    position: "HM. Primary School",
    // socialNetworks: [
    //   {
    //     name: "Linkedin",
    //     url: "https://www.linkedin.com/in/leopoldo-miranda/",
...
export const Team = () => {
  return (
    ...
    >
      ...
      <p className="mt-4 mb-10 text-xl text-muted-foreground">
        Dedicated to guiding and supporting students and teachers, our leadership team is committed to excellence in education.
      </p>
        ...
        {teamList.map(
          ({ imageUrl, name, position }: TeamProps) => (
            ...
            >
              ...
              <CardContent className="text-center pb-2">
                <p>
                  {name} serves as the {position}, fostering growth and collaboration within the school community.
                </p>
              </CardContent>
            </Card>
          )
